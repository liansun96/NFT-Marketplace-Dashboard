    ...
    <div className="flex flex-col items-center justify-between gap-5 w-full lg:w-[50%]">
      <div className="flex flex-col gap-5 p-5 rounded-2xl bg-secondary w-full">
        ...
        <p className="text-body_text text-sm font-semibold">
          It's crafted with the latest trend of design & coded with all modern <br />
          approaches.
        </p>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-5 w-full">
        <div className="flex items-center justify-between gap-5 w-full lg:w-[50%] bg-secondary p-5 rounded-2xl">
